        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">กำลังยืม</h1>
                    </div>
         ...
         <table id="example" class="display nowrap table" width="100%"> 
            <thead>
              ...
              <?php
                       $sql="SELECT * FROM borrow_db b,order_borrow o, status_tbl s ,record_borrow c, register_db r,product_borrow p , product_devicename d , product_brand n , product_model m 
                       WHERE b.orderID=o.orderID and b.status_id=s.status_id and b.status_id=8 and b.m_id=r.m_id and o.pro_id=p.pro_id and p.devicename_id=d.devicename_id and p.brand_id=n.brand_id 
                       and p.model_id=m.model_id and b.orderID=c.orderID and  c.status_id=s.status_id order by b.status_id  ";
                       $result=mysqli_query($conn,$sql);
