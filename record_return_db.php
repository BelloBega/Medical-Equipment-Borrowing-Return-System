            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ทำรายการคืน</h1>
                    </div>
                    ...
                    <div class="col-md-8 py-4">
                        ...
                        <form class="row" method="POST">
                            ...
                            <option value="c.orderID" <?php if(isset($_POST["select"])) {if($_POST['select'] == "c.orderID") {echo"selected";}}?>>เลขที่ใบจอง</option>
                        ...
                        <?php
                           if(isset($_POST['submit'])) {
                            $num=1;
                            $sql="SELECT * FROM borrow_db b , register_db r ,record_borrow c WHERE b.orderID = c.orderID and c.status_id IN (8,9) and b.status_id = '8' and b.m_id=r.m_id  and ".$_POST['select']." LIKE '".$_POST['value']."%' " ;
                                ...
                                <table class="table table-bordered mt-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                         ...
                                         <td><a href="detail_record_return.php?id=<?=$result['orderID']?>" class="btn btn-success mb-4" >คลิก</a></td>
                                        </tr>
                                        <?php
                                           }
                                        ?>
