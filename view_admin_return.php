...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            and p.model_id=m.model_id and b.status_id='8' and r.status_id='8' and r.machinecode=t.machinecode and p.devicename_id=t.devicename_id and r.status_id=s.status_id
