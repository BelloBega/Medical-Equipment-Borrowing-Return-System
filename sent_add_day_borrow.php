...
include 'condb.php';
 ...
 WHERE b.orderID=c.orderID and b.status_id=s.status_id and b.status_id='8' and b.m_id=r.m_id and c.status_id='8' 
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4"> 
                    ...
                    <div class="row"> 
                          ...
                          <div class ="card-body"> 
                                 ...
                                 <th width="10%"><center>เลือกเครื่อง</center></th>
                                 </tr> 
            ...
            and p.model_id=m.model_id and b.status_id IN (6,8) and r.status_id='8' and r.machinecode=t.machinecode and p.devicename_id=t.devicename_id and r.status_id=s.status_id
         ...
         <tbody> 
            <?php foreach ($result as $row) { ?> 
               ...
               <td align=center> 
               <a href="detail_sent_add_day_borrow.php?id=<?=$row['orderID']?>&machinecode=<?=$row['machinecode']?>" class="btn btn-success mb-4" >คลิก</a>
               </td>
