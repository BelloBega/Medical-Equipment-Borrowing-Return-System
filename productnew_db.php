...
<script> 
  ...
  $.ajax({ 
  url: "select_product.php", //ทำงานกับไฟล์นี้ 
  ...
  $("#product_brand").change(function(){  // 
    ...
    $.ajax({ 
    url: "select_product.php", //ทำงานกับไฟล์นี้ 
    data: "brand_id=" + $("#product_brand").val(),  //ส่งตัวแปร 
    type: "POST", 
    async:false, 
    success: function(data, status) { 
    ...
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ลงทะเบียนเครื่องใหม่</h1>
        ...
        <form method="POST" action="insert_product.php">  
          <div class="col col-md-8" >
            ...
            <input type="text" name="machinecode" class="form-control" required ><br>
            <label>รหัสครุภัณฑ์ </label>  
            <input type="text" name="sapcode" class="form-control" required>  <br>
  
            <?php  
                     $sql = "SELECT * FROM product_devicename";  
                     $query = mysqli_query($conn,$sql);  
            ?>  
            <label>ชื่ออุปกรณ์</label><br>  
            <select name="devicename_id" id="product_devicename" class="form-control">  
                <option value="" selected disabled>กรุณาเลือกชื่ออุปกรณ์</option>  
                <?php foreach ($query as $value){ ?>  
                <option value="<?=$value['devicename_id']?>"><?=$value['devicename']?></option>  
                <?php } ?>  
            </select><br>  
  
            <label>ยี่ห้อ</label><br>  
            <select name="brand_id" id="product_brand" class="form-control">  
            </select><br>  
  
            <label>รุ่น</label><br>  
            <select name="model_id" id="product_model" class="form-control">  
            </select><br>  
