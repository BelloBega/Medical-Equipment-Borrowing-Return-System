...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
             ...
             <div class="d-sm-flex align-items-center justify-content-between mb-4"> 
                        <h1 class="h3 mb-0 text-gray-800">ไม่อนุมัติการจอง</h1> 
                    </div> 
 ...
 <?php 
             ...
             WHERE o.orderID=b.orderID  and o.pro_id=p.pro_id and o.orderID='$ids' and b.status_id='11' and p.devicename_id=d.devicename_id and p.brand_id=n.brand_id 
             and p.model_id=m.model_id and b.status_id=s.status_id
             order by o.pro_id  , b.status_id"; 
             $result=mysqli_query($conn,$sql); 
