...
<?php 
  ...
  // WHERE p.status_id=s.status_id and p.devicename_id = d.devicename_id and p.brand_id = b.brand_id and p.model_id=m.model_id
...
<div class="card-body"> 
    <div align="center">
        ...
        <img src="images/<?=$row['images']?>" width="200" height="150" class=" p-2 my-2 "> <br> 
              ...
              จำนวนทั้งหมด : <?=$row["count_product"]; ?><br> 

              จำนวนที่เหลือ : <?=$row["amount"]; ?><br> 
        <?php   
         if($amount1 <= 0){ ?>
              <a href="#" class="btn btn-outline-danger mt-3 mb-4 disabled">เครื่องหมด</a>
    
        <?php } else{  ?>
               <a href="borrow_order.php?id=<?=$row["pro_id"]?>" class="btn btn-outline-success mt-3 mb-4">จองเครื่อง</a>
        <?php } ?>
            ...
            <div class="d-sm-flex align-items-center justify-content-between">
                        <h1 class="h3 mb-0 text-gray-800">ข้อมูลการยืม-คืนเครื่อง  </h1>
                        <br><br>
                    </div>
            <div class="row"> 
 ...
 <?php  
             $sql="SELECT * FROM  borrow_db b , record_borrow r , product P , status_tbl s , register_db g   
             WHERE b.orderID=r.orderID and  r.status_id=s.status_id  and r.status_id='8' and b.status_id='8' and b.m_id=g.m_id 
             and r.machinecode=p.machinecode and p.devicename_id='$devicename_id' ORDER BY r.update_return ASC";  
             $result=mysqli_query($conn,$sql);  
 ?>  
