...
<body id="page-top">
            ...
            <div id="content">
             ...
             <div class="d-sm-flex align-items-center justify-content-between mb-4"> 
                    ...
                    <div class ="card-body"> 
                                           ...
                                           <th width="10%"><center>วันที่ต้องคืนเดิม</center></th>
                                           <th width="10%"><center>วันที่ต้องคืนเครื่องใหม่</center></th>
 ...
 <?php 
             $sql="SELECT * FROM  order_borrow o , product_borrow p , borrow_db b , product_devicename d , product_brand n , product_model m , status_tbl s ,add_day_borrow a ,record_borrow r
             ...
             and p.model_id=m.model_id  and a.status_id=s.status_id and a.status_id=7  and b.orderID=a.orderID and a.orderID=r.orderID and r.machinecode=a.machinecode 
