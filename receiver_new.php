...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ลงทะเบียนรายชื่อผู้มารับ-ส่งเครื่องใหม่</h1>
        ...
        <form method="POST" action="insert_receiver.php">  
         <div class="col-sm-8" >
            <label>รหัสพนักงาน</label>  
            <input type="text" name="name_id" class="form-control" required ><br>

            <label>ชื่อ-นามสกุล</label>  
            <input type="text" name="fullname" class="form-control" required ><br>  

            <label>ชื่อหน่วยงาน</label>  
            <input type="text" name="agencyname" class="form-control" required ><br>  
            ...
            <a href="receiver.php" class="btn btn-danger mb-4 mt-4">ยกเลิก</a> 
            </div>
        </form>  
        </div>  
     </div>
