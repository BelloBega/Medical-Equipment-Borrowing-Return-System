...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">แก้ไขข้อมูลผู้มารับ-ส่งเครื่อง</h1>
                    ...
                    <div class="row">
                              ...
                              <?php
                                $query = "SELECT * FROM receiver WHERE name_id='$id' ";  
            ...
            <input type="text" name="name_id" class="form-control" value=<?=$row['name_id']?> > <br>
            <label>ชื่อ-นามสกุล</label>
            <input type="text" name="fullname" class="form-control" value=<?=$row['fullname']?> ><br>
            <label>ชื่อหน่วยงาน</label>
            <input type="text" name="agencyname" class="form-control" value=<?=$row['agencyname']?> ><br>
            <label>สถานที่ตั้ง</label>
            <input type="text" name="location" class="form-control" value=<?=$row['location']?> ><br>
            <label>ตำแหน่ง </label>
