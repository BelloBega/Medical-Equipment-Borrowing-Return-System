...
<div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <ul class="navbar-nav ml-auto">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-8 py-4">
                        ...
                        <form class="row" method="POST">
                            ...
                            <option value="orderID" <?php if(isset($_POST["select"])) {if($_POST['select'] == "orderID") {echo"selected";}}?>>เลขที่ใบจอง</option>
                            <option value="b.m_id" <?php if(isset($_POST["select"])) {if($_POST['select'] == "b.m_id") {echo"selected";}}?>>รหัสผู้จอง</option>
                        ...
                        <?php
                           if(isset($_POST['submit'])) {
                            $num=1;
                            $sql="SELECT * FROM borrow_db b , register_db r WHERE b.status_id IN (6,7,8,9,10,11,12) and b.m_id=r.m_id  and ".$_POST['select']." LIKE '".$_POST['value']."%' " ;
                                ...
                                <table class="table table-bordered mt-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                         ...
                                         <td> <?php echo $result["re_date"]; ?></td>
                                         <td><a href="detail_record_borrow.php?id=<?=$result['orderID']?>" class="btn btn-warning mb-4" >คลิก</a></td>
                                        </tr>
                                        <?php
                                           }
                                        ?>
         ...
         <?php 
            $sql="SELECT * FROM borrow_db b , register_db r  WHERE b.status_id IN (6,7,8,9,10,11,12) and b.m_id=r.m_id 
          ...
          ?> 
            ...
            <?php foreach ($result as $row) { ?> 
               ...
               <td><a href="detail_reserve_admin.php?id=<?=$row['orderID']?>" class="btn btn-warning mb-4" >คลิก</a></td> 
            </tr> 
