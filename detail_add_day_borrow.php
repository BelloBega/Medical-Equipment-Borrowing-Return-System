...
include 'condb.php'; 
 $ids=$_GET['id'];  
 $sql="SELECT * FROM borrow_db b , register_db r ,status_tbl s  WHERE b.status_id=8 and b.m_id=r.m_id "; 
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">อนุมัติการยืมเครื่องต่อ</h1>
 ...
 <?php 
             $sql="SELECT * FROM  order_borrow o , product_borrow p , borrow_db b , product_devicename d , product_brand n , product_model m , status_tbl s ,add_day_borrow a
             ...
             and p.model_id=m.model_id  and a.status_id=s.status_id and a.status_id IN (7,13)  and b.orderId=a.orderID
 ...
 ?> 
             ...
             <?php foreach ($result as $row) { ?> 
                ...
                <td> 
                     <?php echo $row["new_date_return"]; ?> 
                </td> 
                <td> 
                     <?php echo $row["status_name"]; ?> 
                </td> 
                <td> 
                <a href="approve_add_day_borrow_detail.php?id=<?=$row['orderID']?>&pro_id=<?=$row['pro_id']?>" class="btn btn-success mb-4">อนุมัติ</a> 
                </td> 
             </tr> 
         </tbody>  
              ...
              ?>     
               ...
               <a href="request_add_day_borrow_db.php" class="btn btn-success mb-4 mt-4">เสร็จสิ้น</a> 
               <a href="request_add_day_borrow_db.php" class="btn btn-danger mb-4 mt-4">ยกเลิก</a> 
          </div> 
          </div> 
