        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                  ...
                  <?php 
                        $sql="SELECT * FROM borrow_db b , register_db r , add_day_borrow a  WHERE b.orderID=a.orderID and a.status_id = '13' and b.m_id=r.m_id 
            ...
            <?php foreach ($result as $row) { ?> 
                <tr> 
                    ...
                    <td> <a href="detail_add_day_borrow.php?id=<?=$row['orderID']?>" class="btn btn-success mb-4" >รายละเอียด</a></td> 
                </tr> 
