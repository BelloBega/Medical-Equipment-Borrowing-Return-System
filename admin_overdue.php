    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">เกินกำหนดคืนเครื่อง</h1>
                    ...
                    <table  id="example" class="display nowrap table" width="100%">  
                     <thead>
                      <tr class="table-info"> 
                        ...
                        <th width="10%"><center>จำนวนวันที่เกินกำหนด</center></th>
         ...
         <?php 
             ...
             WHERE  b.status_id=s.status_id  and b.status_id=8  and DATEDIFF(b.date_return, CURDATE()) ";  
...
<tbody>  
             <?php foreach ($result as $row) { ?>  
                ...
                <td align="center">
                <a href="view_admin_overdue.php?id=<?=$row['orderID']?>" class="btn btn-success mb-4" >คลิก</a>
                </td> 
             </tr>  
         </tbody>              
