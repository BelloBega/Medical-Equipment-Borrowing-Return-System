...
<body id="page-top">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admin_page.php">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">บันทึก อนุมัติ/ไม่อนุมัติการจอง</h1>
                    ...
                    <div class="row">
             <?php
             $query="SELECT * FROM  order_borrow o , product_borrow p , borrow_db b , product_devicename d , product_brand n , product_model m
             WHERE o.orderID=b.orderID  and o.pro_id=p.pro_id and b.status_id IN (6,7,11) and p.devicename_id=d.devicename_id and p.brand_id=n.brand_id and p.model_id=m.model_id and o.pro_id='$pro_id'
             order by o.pro_id and o.orderID "; 
            ...
            <form method="POST" action="update_approve.php?id=<?=$row['orderID']?>&pro_id=<?=$row['pro_id']?>">
            ...
            <input type="text" name="orderQty_up" class="form-control" value="<?=$row['orderQty']?>" ><br>
