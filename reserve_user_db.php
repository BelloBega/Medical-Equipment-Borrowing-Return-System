...
<body id="page-top">
    ...
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ข้อมูลการจอง</h1>
                    </div>
        ...
        <tr class="table-info"> 
           ...
           <th width="10%"><center>ชื่อผู้ขอยืม</center></th>
...
<?php
                       $sql="SELECT * FROM borrow_db b,order_borrow o, status_tbl s , register_db r,product_borrow p , product_devicename d , product_brand n , product_model m 
                       WHERE b.orderID=o.orderID and b.status_id=s.status_id and b.m_id=r.m_id and o.pro_id=p.pro_id and p.devicename_id=d.devicename_id and p.brand_id=n.brand_id and p.model_id=m.model_id
