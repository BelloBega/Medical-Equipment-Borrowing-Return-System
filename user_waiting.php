        ...
        <div id="content-wrapper" class="d-flex flex-column">
         ...
         <table id="example" class="display nowrap table" width="100%"> 
                   ...
                   <?php
                       ...
                       WHERE b.orderID=o.orderID and b.status_id=s.status_id and b.status_id=6 and b.m_id=r.m_id and o.pro_id=p.pro_id and p.devicename_id=d.devicename_id and p.brand_id=n.brand_id 
                       and p.model_id=m.model_id order by b.status_id  ";
                       $result=mysqli_query($conn,$sql);
