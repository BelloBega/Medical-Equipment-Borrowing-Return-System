        ...
        <div id="content-wrapper" class="d-flex flex-column">
         ...
         <tbody> 
            <?php foreach ($result as $row) { ?> 
               ...
               <td> 
                <a href="return_detail.php?id=<?=$row['orderID']?>&pro_id=<?=$row['pro_id']?>&machinecode=<?=$row['machinecode']?>" class="btn btn-success mb-4">คืน</a> 
                </td> 
             ...
             <?php } ?> 
                        ...
                        <div style="text-align:right">  
                               <a href="update_record_return.php?status_id=<?=$row['status_id']?>&id=<?=$row['orderID']?>" class="btn btn-warning mb-4" onclick="Del1(this.href);return false;">บันทึกการคืน</a> 
                               <a href ="record_return_db.php"><button type="button" class="btn btn-danger mb-4">ยกเลิก</button></a>  
                            </div>  
...
<script language="JavaScript"> 
   function Del1(mypage1){ 
     var agree=confirm("เลขที่ใบจองนี้คืนเครื่องครบแล้วหรือไม่?"); 
     if(agree){ 
