...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
             ...
             <a href="product_count.php?id=<?=$row["devicename_id"]?>" class="btn btn-outline-success mt-3 mb-4">คงเหลือ</a> 
            ...
            <?php } ?>  
                   ...
                   <div class="container">
                     ...
                     <div class="d-sm-flex align-items-center justify-content-between">
                        <h1 class="h3 mb-0 text-gray-800">ข้อมูลผู้มารับเครื่องใน7วัน  </h1>
                        <br><br>
                    </div>
 ...
 <?php  
           ...
           $date_7 = date('Y-m-d',strtotime("-7 days"));
             ...
             $sql1="SELECT * FROM  record_borrow r , product p , status_tbl s , product_devicename d , product_brand b , product_model m
             WHERE r.machinecode=p.machinecode and  p.devicename_id = d.devicename_id and p.brand_id = b.brand_id and p.model_id=m.model_id
             and r.status_id=s.status_id and date_come BETWEEN '$date_7' AND '$today_date'  ORDER BY r.date_come";  
             $result1=mysqli_query($conn,$sql1);   
 ?>  
             ...
             <?php foreach ($result1 as $row1) { ?>  
                 <tr>  
                 <td>  
                     <?php echo $row1["b_receiver"]; ?>  
                  </td>  
                  <td>  
                     <?php echo $row1["machinecode"]; ?>  
                  </td>  
                  <td>  
                     <?php echo $row1["devicename"]; ?>  
                  </td>  
                  <td>  
                ...
                <td>  
                     <?php echo $row1["date_come"]; ?>  
                </td>  
                <td>  
                     <?php echo $row1["status_name"]; ?>  
                </td> 
             </tr>  
         </tbody>          
