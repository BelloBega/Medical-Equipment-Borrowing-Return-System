        ...
        <ul class="navbar-nav ml-auto">
            ...
            <div class="topbar-divider d-none d-sm-block"></div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">รายชื่อข้อมูลพนักงานที่มารับ-ส่งเครื่อง</h1>
                        <a href="receiver_new.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-plus fa-sm text-white-50"></i> ลงทะเบียนรายชื่อใหม่</a>
                    </div>
                    ...
                    <div class="col-md-8 py-4">
                        ...
                        <form class="row" method="POST">
                            ...
                            <option value="name_id" <?php if(isset($_POST["select"])) {if($_POST['select'] == "name_id") {echo"selected";}}?>>รหัสผู้รับ-ส่งเครื่อง</option>
                            <option value="fullname" <?php if(isset($_POST["select"])) {if($_POST['select'] == "fullname") {echo"selected";}}?>>ชื่อผู็รับ-ส่งเครื่อง</option>
                            <option value="agencyname" <?php if(isset($_POST["select"])) {if($_POST['select'] == "agencyname") {echo"selected";}}?>>ชื่อหน่วยงาน</option>
                            <option value="location" <?php if(isset($_POST["select"])) {if($_POST['select'] == "location") {echo"selected";}}?>>สถานที่ตั้ง</option>
                            </select>
                            </div>
                            <div class="col">
                        ...
                        <?php
                           if(isset($_POST['submit'])) {
                            $num=1;
                            $sql="SELECT * FROM receiver WHERE ".$_POST['select']." LIKE '".$_POST['value']."%' " ;
                            ...
                            if($check_data == 0) {
                                ...
                                <table class="table table-bordered mt-4">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                         <td> <?php echo $result["name_id"]; ?></td>
                                         <td> <?php echo $result["fullname"]; ?></td>
                                         <td> <?php echo $result["agencyname"]; ?></td>
                                         <td> <?php echo $result["location"]; ?></td>
                                         <td> <?php echo $result["position"]; ?></td>
                                         <td> <?php echo $result["tel"]; ?></td>
                                         <td><a href="edit_receiver.php?name_id=<?=$result["name_id"]?>" class="btn btn-warning mb-4">edit</a></td>
                                         <td><a href="delete_receiver.php?name_id=<?=$result["name_id"]?>" class="btn btn-danger mb-4" onclick="Del(this.href);return false;">delete</a></td>
                                        </tr>
                                        <?php
                                           }
                                        ?>
            ...
            <?php foreach ($result as $row) { ?> 
                ...
                <td>
                                   ...
                                   <td><a href="edit_receiver.php?name_id=<?=$row["name_id"]?>" class="btn btn-warning mb-4">edit</a></td>
                                   <td><a href="delete_receiver.php?name_id=<?=$row["name_id"]?>" class="btn btn-danger mb-4" onclick="Del(this.href);return false;">delete</a></td>
            </tr> 
