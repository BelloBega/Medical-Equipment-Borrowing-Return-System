            ...
            <div class="topbar-divider d-none d-sm-block"></div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ทำรายการยืม</h1>
                    ...
                    <div class="col-md-8 py-4">
                        ...
                        <?php
                           if(isset($_POST['submit'])) {
                            $num=1;
                            $sql="SELECT * FROM borrow_db b , register_db r WHERE b.status_id = '7' and b.m_id=r.m_id  and ".$_POST['select']." LIKE '".$_POST['value']."%' " ;
                                ...
                                <table class="table table-bordered mt-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                         ...
                                         <td><a href="detail_record_borrow.php?id=<?=$result['orderID']?>" class="btn btn-success mb-4" >คลิก</a></td>
                                        </tr>
                                        <?php
                                           }
                                        ?>
