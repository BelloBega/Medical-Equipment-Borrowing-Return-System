...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ที่ต้องมารับเครื่อง</h1>
         ...
         <?php 
             $sql="SELECT * FROM    borrow_db b, status_tbl s
             WHERE b.status_id='7' and  b.status_id=s.status_id
             order by b.up_date "; 
         ...
         ?> 
             ...
             <?php foreach ($result as $row) {
                 ...
                 <td align="center">  
                  ...
                  <td align="center">
                    <?php $up_date = date('Y-m-d',strtotime($row['up_date']));
                          $datenow = date('Y-m-d');
                         ...
                         //echo 'วันปัจจุบัน' .$datenow;
                          ...
                          $caldate = round(abs(strtotime("$up_date") - strtotime("$datenow"))/60/60/24);

                          echo $caldate. 'วัน';
                          echo '<br>';
                          if($caldate > 1){
                            echo "<a href ='view_admin_come.php?id=$orderID&do=orderID_cancel' class='btn btn-danger mb-4' >ยกเลิก</a>" ;
                          }else{
                            echo'';
                          }
                    ?>
                  ...
                  <td align="center">  
                  <a href="view_admin_come.php?id=<?=$row['orderID']?>&do=orderID_detail" class="btn btn-success mb-4" >คลิก</a>
                  </td>  
             </tr>  
         </tbody>          
